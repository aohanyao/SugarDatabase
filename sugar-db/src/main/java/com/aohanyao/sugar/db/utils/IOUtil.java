package com.aohanyao.sugar.db.utils;
...
//        mapOriginal.put("key1", "value1");
//        mapOriginal.put("key2", "value2");
//        mapOriginal.put("key3", "value3");
//        //{"key1":"value1","key2":"value2","key3":"value3"}
//        String json = new Gson().toJson(mapOriginal);
//
//
//        Map<String, String> mapResolve = new Gson().
//                fromJson(json, new TypeToken<Map<String, Point>>() {
//                }.getType());
